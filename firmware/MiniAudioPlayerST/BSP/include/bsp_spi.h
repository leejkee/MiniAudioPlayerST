...
#include "main.h"
  ...
  */
    HAL_StatusTypeDef BSP_SPI_RW(const bsp_spi_context_t *context, uint8_t tx_data,
                                 uint8_t *rx_data, uint32_t timeout);
  ...
  */
    ...
    */
    HAL_StatusTypeDef BSP_SPI_Tx_DMA(const bsp_spi_context_t *context, const uint8_t *buf,
                                     uint16_t len);
